...
class Settings(BaseSettings):
    ...
    dewey_decay_seconds: int = (
        10  # seconds per decay unit (10 = fast demo, 86400 = realistic daily)
    )
    streak_cooldown_seconds: int = (
        5  # seconds between reviews for streak (5 = fast demo, 86400 = daily)
    )

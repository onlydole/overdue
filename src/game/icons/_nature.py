...
def register_icons(register) -> None:  # noqa: ANN001
    ...
    # ------------------------------------------------------------------
    # FIRE -- tall flame with multi-layer color gradient
    # ------------------------------------------------------------------
    # Extra blended tones for richer fire gradients
    _fire_white_core = blend_colors(WHITE, _gold_hi, 0.3)
    _fire_gold_orange = blend_colors(_gold_sh, _flame_hi, 0.5)
    ...
    register(
        ...
        [
            ...
            (6, 14, _aa_flame_bg),
            (7, 14, _aa_flame_bg),
            # --- single flicker sparks and heat shimmer ---
            (4, 5, _aa_gold_bg),
            (13, 9, _aa_flame_bg),
            (2, 10, _aa_flame_bg),
            (2, 12, _aa_flame_bg),

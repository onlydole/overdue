...
- **12 pixel art librarian avatars** -- custom 16x16 shoulders-up portraits built from code
...
- **Avatars** (16x16): 12 custom librarian portraits with unique hair styles, skin tones, outfits, and optional glasses. Rendered as inline SVG via `render_avatar()` in Jinja2 templates.

...
- **12 pixel art librarian avatars** -- custom 32x32 shoulders-up portraits built from code
...
- **Avatars** (32x32): 12 custom librarian portraits with unique hair styles, skin tones, outfits, and optional glasses. Rendered as inline SVG via `render_avatar()` in Jinja2 templates.
